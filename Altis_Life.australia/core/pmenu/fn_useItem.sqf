...
switch (true) do {
	...
	case (_item in ["apple","rabbit_Grilled","salema_Grilled","ornate_Grilled","mackerel_Grilled","tuna_Grilled","mullet_Fried","catshark_Fried","turtle_soup","donut","tbacon","peach","goat_Grilled","sheep_Grilled","rooster_Grilled","hen_Fried"]): {
